          ...
          {!role ? (
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-8">
                {[
                  { k: "developer", icon: Code2, t: "I'm a Developer", d: "Earn globally" },
                  { k: "client", icon: Briefcase, t: "I'm a Client", d: "Hire top talent" },
                ].map((o) => (
                  <button
                    key={o.k}
                    onClick={() => setRole(o.k as any)}
            ...
            <form
              onSubmit={(e) => { e.preventDefault(); toast.success("Account created! (demo)"); }}
            ...
            >
              ...
              <div className="space-y-4">
                <div><Label>Full name</Label><Input className="mt-1.5" placeholder="Ada Lovelace" /></div>
              ...
              <Button type="submit" className="w-full mt-6 bg-[image:var(--gradient-primary)] text-primary-foreground h-11">Create account</Button>
